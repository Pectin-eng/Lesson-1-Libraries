...
Original file is located at
    https://colab.research.google.com/drive/1NGDVhdKkxF9vm3AtE7zKytupGUGxo_f-
"""
...
# authors со столбцами author_id и author_name, в которых соответственно содержатся данные:
